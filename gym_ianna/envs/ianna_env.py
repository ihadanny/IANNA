...
class IANNAEnv(gym.Env):
    ...
    def __init__(self):
        ...
        #        0) action_type:            filter[0], group[1]
        ...
        self.grouped_by = {col: 0 for col in self.columns}
        
        self.action_space = spaces.MultiDiscrete([[0,1], [0, self.num_columns-1], [0, 2], [0, 9], [0, self.num_columns-1], [0,4]])
